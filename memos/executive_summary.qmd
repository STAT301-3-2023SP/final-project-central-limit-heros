...
Our outcome variable is an index (the "Gayborhood index") from a dataset published on [data world](https://data.world/the-pudding/gayborhoods). This index is a holistic assessment of a neighborhood's queerness, based on a number of factors such as number of same sex households, number of gay bars, and pride parade routes. This index is assigned by zip code. Our predictors were taken from datasets on [housing characteristics](https://data.census.gov/table?q=rent&g=010XX00US$8600000&tid=ACSDP5Y2021.DP04.), [demographic information](https://data.census.gov/table?g=010XX00US$8600000&tid=ACSDP5Y2015.DP05.) not related to sexuality, and [transport to work](https://data.census.gov/table?q=commuting&g=010XX00US$8600000&tid=ACSST5Y2021.S0802.) from the US census, as well as a dataset on the amount of [park space](https://doi.org/10.3886/E119803V1.) per zip code.
